...
Note: {log()} computes the natural logarithm by default. See {?log} to compute a logarithm with a different base.\

# Documentation

One convenient feature in {R} is the documentation for all functions. If you want to learn more about a function and its arguments you can simply type a question mark in front of the function name or use the {help()} function.
